...
import { Laptop, Phone, Globe, Cpu, ArrowRight, HeartHandshake, Zap, Target, Flame, Headset, Share2, Code2, ShoppingBag, Cloud, BrainCircuit, GraduationCap, Radio, SearchCode, ShieldAlert, Glasses, Smartphone, CheckCircle } from "lucide-react";
  ...
  const services = [
    {
      ...
      description: "Custom enterprise software architectures, desktop utilities, and secure database frameworks designed to fit your unique workflows.",
      icon: <Code2 className="w-8 h-8 text-primary" />,
      href: "/web_apps_development.php",
    },
    {
      title: "Web & E-Commerce Solutions",
      description: "Interactive storefronts, multi-vendor marketplaces, payment integrations, and responsive business platforms built for high conversions.",
      icon: <ShoppingBag className="w-8 h-8 text-secondary" />,
      href: "/e_commerce_development.php",
    },
    {
      title: "Cloud Computing & DevOps",
      description: "Secure database migrations, CI/CD pipeline automation, and hosted Linux/Windows server environments with isolated security rules.",
      icon: <Cloud className="w-8 h-8 text-accent" />,
      href: "/vps_dedicated_hosting_in_nashik.php",
    },
    {
      title: "AI, ML & Data Science",
      description: "Implement predictive analytics models, machine learning algorithms, database miners, and data visualizations into active business apps.",
      icon: <BrainCircuit className="w-8 h-8 text-indigo-500" />,
      href: "/web_apps_development.php",
    },
    {
      title: "Training & Internships",
      description: "Practical classroom bootcamps, stipend programs, and real-world project experience covering full stack web development architectures.",
      icon: <GraduationCap className="w-8 h-8 text-emerald-500" />,
      href: "/internship.php",
    },
    {
      title: "IoT & Embedded Systems",
      description: "Automate machine logs, configure diagnostic controllers, compile firmwares, and build sensor-to-server hardware dashboards.",
      icon: <Radio className="w-8 h-8 text-amber-500" />,
      href: "/enterprise_application.php",
    },
    {
      title: "Digital Marketing & SEO",
      description: "Organic search engine optimization, local Google Listings, post campaigns, and targeted social ad sets to maximize company leads.",
      icon: <SearchCode className="w-8 h-8 text-primary" />,
      href: "/social_media_marketing.php",
    },
    {
      title: "Cybersecurity Solutions",
      description: "Penetration tests, database encryption audits, SSL configurations, server access controls, and monthly security logs.",
      icon: <ShieldAlert className="w-8 h-8 text-rose-500" />,
      href: "/privacy_policy_domain_hosting_data_security.php",
    },
    {
      title: "AR / VR Solutions",
      description: "Engaging 3D visual models, Unity simulations, immersive layouts, and virtual tours customized for medical or real estate.",
      icon: <Glasses className="w-8 h-8 text-violet-500" />,
      href: "/corporate_website_design.php",
    },
    {
      title: "Mobile App Development",
      description: "Native and cross-platform Android & iOS development with secure APIs, push notifications, and offline data sync.",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center mb-16">
            ...
            <p className="text-slate-500 mt-4 leading-relaxed">
              We deliver custom web architectures, scalable e-commerce portals, native mobile apps, and result-oriented digital campaigns.
            </p>
          </div>
