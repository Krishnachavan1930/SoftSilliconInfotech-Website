...
export default function AboutPage() {
  ...
  return (
    <div className="space-y-0">
      ...
      {/* 4. Life at SiliconSoft & Work Culture Gallery */}
      <section className="py-24 bg-slate-50 border-t border-slate-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center mb-16">
            ...
            <h2 className="text-3xl sm:text-4xl font-extrabold text-slate-900 mt-3 font-heading tracking-tight">
              Life at SiliconSoft: Work Hard, Celebrate Harder
            </h2>
            <p className="text-slate-500 mt-3 text-sm leading-relaxed">
              A dynamic environment built on creative discussions, constant skill learning, agile teamwork, and collaborative achievements.
            </p>
          </div>
