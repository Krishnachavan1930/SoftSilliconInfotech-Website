...
const internshipFormSchema = z.object({
  ...
  course: z
    .string()
    .min(2, "Please specify your course (e.g. B.Tech, MCA)"),
  ...
  domain: z
    .string()
    .min(2, "Please select an internship domain"),

  // Resume link is OPTIONAL.
  // Candidate can upload a file instead.
  resumeLink: z
    .string()
    .optional()
    .or(z.literal("")),
...
type InternshipFormValues =
  z.infer<typeof internshipFormSchema>;
  ...
  const timelineSteps = [
    {
      step: "1",
      title: "Apply Online",
      desc: "Submit your basic details and resume link or upload your resume via our online form.",
      icon: <FileCheck size={20} />,
    },
    {
      step: "2",
      title: "Resume Screening",
      desc: "Our recruitment team audits applicant portfolios and academic credits.",
      icon: <Compass size={20} />,
    },
    {
      step: "3",
      title: "Technical Discussion",
      desc: "Quick call or dashboard task to map your coding or analytical aptitude.",
      icon: <Cpu size={20} />,
    },
    {
      step: "4",
      title: "Selection",
      desc: "Offer letter is shared with selected candidates detailing schedules.",
      icon: <Award size={20} />,
    },
    {
  step: "5",
  title: "Internship Begins",
  desc: "Onboard into active developer circles and kickstart live training.",
  ...
  const benefits = [
    {
      ...
      desc: "Experience commercial software development standards firsthand.",
    },
    {
      title: "Live Projects",
      desc: "Write actual code that runs on live production systems.",
    },
    {
      title: "Flexible Learning",
      desc: "Coordinate training tasks around your college timetables.",
    },
    {
      title: "Experienced Mentors",
      desc: "Direct debugging support from senior framework developers.",
    },
    {
      title: "Team Collaboration",
      desc: "Participate in agile review standups and group tasks.",
    },
    {
      title: "Practical Assignments",
      desc: "Resolve actual issues, compile queries, and inspect code safety.",
    },
    {
      title: "Career Guidance",
      desc: "Mock resume feedback, interviews coaching, and career maps.",
    },
    {
      title: "Completion Certificate",
      desc: "Official verification credit detailing your milestones.",
    },
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div className="relative w-80 h-80 sm:w-96 sm:h-96 rounded-full bg-slate-900 border border-slate-800 flex items-center justify-center shadow-2xl">
              ...
              <GraduationCap
                size={120}
                className="text-primary opacity-80 animate-pulse-subtle"
              />
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6">
          ...
          <div className="bg-white border border-slate-100 rounded-3xl p-8 sm:p-12 shadow-sm">
            ...
            {submitError ? (
              ...
              <div
                className="bg-rose-50 border border-rose-200 text-rose-700 p-4 rounded-2xl text-sm mb-8"
                role="alert"
              >
                {submitError}
              </div>
            ...
            >
              ...
              <div className="space-y-5">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-400 mt-1">
                    Provide your resume using a link or upload the file directly.
                  </p>
                ...
                <div className="space-y-2">
                  ...
                  <div className="border-2 border-dashed border-slate-200 rounded-2xl p-5 bg-slate-50 hover:border-primary hover:bg-white transition-all">
                  ...
                  {resumeFile && (
                    ...
                    <div className="flex items-center justify-between gap-3 bg-emerald-50 border border-emerald-200 rounded-xl px-4 py-3">
                      ...
                      <button
                        ...
                        className="text-xs font-semibold text-rose-500 hover:text-rose-700 cursor-pointer shrink-0"
                      >
                        Remove
                      </button>
              ...
              <button
                ...
                className="btn bg-primary text-white hover:bg-primary-dark w-full py-3 flex items-center justify-center space-x-2 cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
              >
