  ...
  const offices = [
    {
      city: "Nashik",
      address:
        "410, 4th Floor, Silicon Business Center, Guru Gobind Singh College Road, Near Pathardi Gaon Circle, Nashik, Maharashtra 422010",
    },
  ];
    ...
    <footer className="bg-slate-950 text-slate-400 pt-16 pb-8 border-t border-slate-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 pb-12 border-b border-slate-950/20">
          ...
          <div className="space-y-6">
            <Link href="/" className="inline-block">
              <div className="relative h-12 w-52">
                <Image
                  ...
                  alt="SoftSillicon Infotech LLP Logo"
                  fill
                  priority
            ...
            <p className="text-sm leading-relaxed text-slate-500">
              Softsilicon Infotech LLP is a group of IT experts, who
              accompanied a promise of conveying technology-enabled business
              solutions. We give world-class software and Web Development
              services.
            </p>
          ...
          <div className="grid grid-cols-2 gap-6 lg:col-span-2">
            ...
            {/* Company Links */}
            <div>
              <h3 className="text-white text-base font-semibold mb-6 uppercase tracking-wider text-xs">
                Company
              </h3>
                ...
                {companyLinks.map((link) => (
                  <li key={link.name}>
                    ...
                    >
                      <ArrowRight
                        size={12}
                        className="mr-2 text-primary opacity-0 group-hover:opacity-100 transition-opacity"
                      />
          ...
          <div>
            ...
            <div className="space-y-4 text-sm text-slate-500">
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <a
                    href="mailto:info@softsiliconinfotech.com"
                    className="hover:text-white block"
                  >
                    info@softsiliconinfotech.com
                  </a>

                  <a
                    href="mailto:softsiliconinfotech@gmail.com"
                    className="hover:text-white block text-xs"
                  >
                    softsiliconinfotech@gmail.com
                  </a>
                </div>
              </div>
        ...
        <div className="pt-8 flex flex-col md:flex-row justify-between items-center text-xs text-slate-600">
          <p>
            © {new Date().getFullYear()} Softsilicon Infotech LLP. All Rights
            Reserved.
          </p>
        </div>
      </div>
