...
export default function SparkCoursesPage() {
  ...
  const courses: Course[] = [
...

    {
      ...
      title:
        "React.js & Next.js Advanced Architecture",
                ...
                >
                  ...
                  <div className="space-y-1">
                    ...
                    >
                      ...
                      <option value="spark-sep">
                        SPARK - Student Fast-Track Bootcamp
                      </option>
                  ...
                  <div className="space-y-1">
                    ...
                    >
                      ...
                      <option value="nashik">
                        Nashik Campus (Guru Gobind Singh College Rd)
                      </option>

                      <option value="pune">
                        Pune Tech Hub Center
                      </option>

                      <option value="online">
                        Online Live Interactive Classroom
                      </option>

                      <option value="hybrid">
                        Hybrid (Classroom + Remote Live Projects)
                      </option>
                  ...
                  <div className="space-y-1">
                    ...
                    >
                      ...
                      <option value="1-month">
                        1 Month (Fast-Track Intensive Bootcamp)
                      </option>

                      <option value="3-months">
                        3 Months (Core Industry Certification)
                      </option>

                      <option value="6-months">
                        6 Months (Comprehensive Diploma + Live Internship)
                      </option>

                      <option value="45-days">
                        45 Days (SPARK Fast-Track Skill Program)
                      </option>

                      <option value="weekend">
                        Weekend Professional Batch
                      </option>
                    ...
                    <div className="relative mb-4">
                      ...
                      <div className="w-44 h-44 sm:w-48 sm:h-48 rounded-full overflow-hidden border-4 border-white shadow-xl bg-gradient-to-b from-red-600 via-red-700 to-slate-900 flex flex-col items-center justify-center relative">
                        ...
                        <div className="relative z-10 flex flex-col items-center">
                          ...
                          <GraduationCap
                            className="text-white drop-shadow-md mb-1"
                            size={44}
                          />
